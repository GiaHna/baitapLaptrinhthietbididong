    ...
    return Scaffold(
      ...
      body: Center(
        child: Container(
          ...
          child: Card(
            color: Colors.white, // Màu nền nhạt của Card
            child: Padding(
              padding: const EdgeInsets.all(16.0),
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: const [
                      Icon(Icons.email),
                      SizedBox(width: 8),
                      Text('Email: phamhanst20@gmail.com'),
                    ],
                  ),
...
class GridPage4 extends StatelessWidget {
  const GridPage4({super.key});
